...
\begin{table}[H]
	...
	\begin{tabular}{p{6cm}|p{6cm}}
		...
		\hline
		\rowcolor{white}
		\textbf{Observeret resultat} & Ugyldig email\\
		\hline
...
\begin{table}[H]
	...
	\begin{tabular}{p{6cm}|p{6cm}}
		...
		\hline
		\rowcolor{white}
		\textbf{Observeret resultat} & At der er ikke indtastes ingen email\\
		\hline
		\textbf{Vurdering (OK/FAIL)} & OK\\
		\hline
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{p{6cm}|p{6cm}}
		...
		\hline
		\rowcolor{white}
		\textbf{Observeret resultat} & For kort password\\
		\hline
		\textbf{Vurdering (OK/FAIL)} & OK\\
		\hline
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{p{6cm}|p{6cm}}
		...
		\hline
		\rowcolor{white}
		\textbf{Observeret resultat} & Ingen password\\
		\hline
		\textbf{Vurdering (OK/FAIL)} & OK\\
		\hline
	\end{tabular}
